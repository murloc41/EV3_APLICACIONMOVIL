...
Diálogo de permiso de Cámara (Android): "Allow camera access?"
Diálogo de permiso de Ubicación (Android): "Allow location access?"
Cámara abierta y luego foto mostrada en interfaz (detalle del paciente)
Ubicación capturada: Texto "Ubicación capturada: Latitud ..., Longitud ..."
Evidencia de persistencia: captura de Logcat con mensajes ✅ Foto guardada y/o ✅ Ubicación guardada
Reinicio de app: mostrar que la foto y "Ubicación RECUPERADA" se recargan correctamente
